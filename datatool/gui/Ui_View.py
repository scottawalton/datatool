...
class Ui_DataTool(object):
    def setupUi(self, DataTool):
        ...
        self.menuHelp.addAction(self.actionDisplay_Command_Prompt)
    ...
    def retranslateUi(self, DataTool):
        ...
        self.menuHelp.setTitle(_translate("DataTool", "View"))
        self.menuEdit.setTitle(_translate("DataTool", "Edit"))
        self.menuHelp_2.setTitle(_translate("DataTool", "Help"))
